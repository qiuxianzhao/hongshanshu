    ...
    function GetPreNext($gtype='')
    {
        ...
        if(count($this->PreNext)<2)
        {
            ...
            if(is_array($preRow))
            {
                ...
                $this->PreNext['pre'] = "<a id='article_up' href='$mlink'>{$preRow['title']}</a> ";
                $this->PreNext['preimg'] = "<a id='article_up' href='$mlink'><img src=\"{$preRow['litpic']}\" alt=\"{$preRow['title']}\"/></a> "; 
            }
            else
            {
                //$this->PreNext['pre'] = "上一篇：没有了 ";
                $this->PreNext['pre'] = "<a id='article_up' href=''></a>";
            ...
            if(is_array($nextRow))
            {
                ...
                $this->PreNext['next'] = "<a id='article_down' href='$mlink'>{$nextRow['title']}</a> ";
                $this->PreNext['nextimg'] = "<a id='article_down' href='$mlink'><img src=\"{$nextRow['litpic']}\" alt=\"{$nextRow['title']}\"/></a> ";
            }
            else
            {
                //$this->PreNext['next'] = "下一篇：没有了 ";
                $this->PreNext['next'] = "<a id='article_down' href=''></a>";
